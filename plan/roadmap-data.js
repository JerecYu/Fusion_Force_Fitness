...
window.FFF_ROADMAP = {
  ...
  meta: {
    updated: '2026-08-09 · 第三幕改為混合版（GT 整套搬、PT 自然迭代）',
  ...
  acts: [
    ...
    /* ══════════ 第三幕 ══════════ */
    {
      ...
      note: '<b>兩種商品，兩種策略（2026-08-09 定案的「混合版」）。</b>因為資料品質差太多：<br><br><b>GT → 整套搬</b>（人 ＋ 四年流水 ＋ 上課歷史）。它有獨立的 <code>members</code> 表、手機 81/81 唯一、帳本自洽 —— 資料是乾淨的，搬它幾乎沒有額外成本，而且順便把歷史一起帶進來。<br><br><b>PT／PGT → 自然迭代</b>（只搬「人 ＋ 還沒用完的堂數」）。它沒有獨立客人表、沒有手機、四年流水混在一張手工表裡。重建那些歷史的成本遠大於價值 —— 而且 2022 年的客人有一大半早就不來了。<br><br><b>RT → 不搬。</b>那份 Excel 只有收款日期和金額，沒有時段也沒有租客，搬進來也不知道場地被誰佔了。等做金流時再處理。<br><br>往後挪不是因為它不重要，而是因為它<b>看不到成果</b> —— 管線通了之後再搬，你才驗證得了自己做對了。',
      milestone: {
        title: '▲ 第三幕結束 — 兩套帳對得起來',
        text: 'GT 那 81 個人、四年的堂數流水、上課歷史全部進來了，而且每一個人的餘額都跟舊系統一模一樣。<b>你手上有兩套帳，而且它們對得起來 —— 這是可以放心搬家的前提。</b>（PT／PGT 走自然迭代，在第 36 步處理。）'
      },
      steps: [
        ...
        { n:27, t:'GT 彩排：完整匯入 ＋ 81 筆逐筆對帳', where:'SQL', done:false,
          summary:'彩排的目的不是上線，是證明工具是對的',
          body:'用備份資料整套跑一次：客人 → 堂數流水 → 上課歷史 → 預約。<br><br><b>對帳方式：</b>查 <code>customer_credits</code>（<code>product=\'GT\'</code>），跟舊系統最後的餘額<b>逐筆</b>比。81 筆要全中 —— 這一步<b>不接受抽查</b>，因為抽查抽不到的那一筆，就是上線後客人打來抱怨的那一筆。<br><br>對完把資料清掉，切換日再跑一次乾淨的。',
    ...
    /* ══════════ 第四幕 ══════════ */
    {
      ...
      steps: [
        ...
        { n:37, t:'切換日：舊系統退場', where:'決定', done:false, kind:'decide',
          ...
          body:'<b>挑哪一天：</b>第 36 步平行週結束的隔天。課最少的那天最好 —— 你的課表裡<b>週三只有一堂</b>（12:20 間歇有氧）。<br><b>前一週：</b>公告「X 月 X 日起改用新系統預約」。<br><br><b>當天照順序做，不要跳：</b><ul><li><b>①</b> <b>舊系統停止購課與消課</b> —— 先把帳凍住，後面每一步才有意義</li><li><b>②</b> 舊系統最後一次完整匯出（GT 那份）</li><li><b>③</b> 用第 26 步的工具產生 SQL</li><li><b>④</b> 清掉彩排資料，正式匯入 GT</li><li><b>⑤</b> <b>81 筆餘額逐筆對帳</b>（跟第 27 步同一套查詢）＋ 抽查幾個 PT 客人的結轉餘額</li><li><b>⑥</b> <b>舊系統設為唯讀，不要刪</b> —— 至少留三個月。要查 2023 年三月那堂課，去那裡查</li></ul>然後把 <code>BOOKING_OPEN</code> 改成 <code>true</code>，公告上線，發綁定指引給還沒綁 LINE 的人。',
          warn:'⚠️ <b>這一天結束時，教練還不能在系統上點名核銷</b>（那是第 39 步）。中間這段期間扣課要你自己在 Table Editor 手動做，或先紙本記、之後補。<br><b>這是已知的取捨，不是疏漏</b> —— 早一點切換，就早一點停掉維護兩套系統的心力。<br><br>⚠️ <b>PT／PGT 的上課歷史從此只存在舊系統。</b>那是刻意的決定，不是漏掉的 —— 舊系統設唯讀就是為了這件事。',
