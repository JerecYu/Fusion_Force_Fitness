...
window.FFF_ROADMAP = {
  ...
  meta: {
    updated: '2026-08-21 · 第 36 步解掉了（卡五天）· 新增第七幕「把帳接起來」，帳務六步順延為第八幕 89～94',
...
,
    ...
    /* ══════════ 第八幕 ══════════ */
    {
      ...
      note: '☢️ <b>這一幕還沒開始蓋。</b>下面六步（89～94）是「帳務完整線上化」剩下的距離 —— 每一步都是<b>現在查得出來的缺口</b>，不是願望清單。<br><br>目前的狀態講白一點：<b>GT 那一側的錢是完整的</b>（購課金額、現金／匯款、待入帳、方案對帳都在），<b>服務登記那一側只記了「賺多少」，沒記「收到沒」</b>，而<b>支出除了教練薪資以外，系統一毛都不知道</b>。',
      milestone: {
        title: '▲ 第八幕結束 — 你會擁有的',
        text: '一個月結束時按一顆鍵，就知道這個月收了多少、發了多少、剩多少。<b>而且那個數字結完就鎖住，不會被明天改的設定悄悄改掉。</b>☢️ 但「錢真的在線上收」不在這一幕裡 —— 那要先搬離 GitHub Pages，在地平線那一頭。'
      },
      steps: [
        { n:89, t:'決定：一個月的「收入」算收到錢那天，還是上完課那天', where:'決定', done:false, kind:'decide',
        ...
        { n:90, t:'服務登記要記「收到錢了沒、怎麼收的」', where:'資料庫 ＋ 前端', done:false,
        ...
        { n:91, t:'對帳報表納入服務登記的錢', where:'資料庫 ＋ 前端', done:false,
        ...
        { n:92, t:'支出簿 —— 薪水以外的錢', where:'資料庫 ＋ 前端', done:false,
        ...
        { n:93, t:'月結 —— 結完就鎖起來', where:'資料庫 ＋ 前端', done:false,
        ...
        { n:94, t:'損益表 —— 一個月一頁', where:'資料庫 ＋ 前端', done:false,
