...
> 📌 **完整的 36 步清單在 `plan/` 資料夾**，用瀏覽器打開 `plan/fff-roadmap-steps.html`。
...
| 訂課 | 假的，存在瀏覽器記憶體 | **關著**，等第 28～30 步 |

**下一個分水嶺是第 28 步的 LINE 身分驗證。** 在那之前訂課功能不能打開 ——
...
**第 30 步才能打開，而且必須先做完第 28、29 步（LINE 身分驗證與綁定）。**
